...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Informática1");
		Categoria cat4 = new Categoria(null, "Informática2");
		Categoria cat5 = new Categoria(null, "Informática3");
		Categoria cat6 = new Categoria(null, "Informática4");
		Categoria cat7 = new Categoria(null, "Informática5");
